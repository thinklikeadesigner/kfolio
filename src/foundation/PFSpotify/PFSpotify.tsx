...
export const PFSpotify = ({ children }: PFSpotifyProps) => {
  return (
    ...
    <Box marginTop={{ sm: "90px", md: "90px", lg: "0px", xl: "0px" }} bgGradient={"linear(to-r, #06636c , #00292e)"} d="flex" flexDirection={"column"} borderRadius="20px" justifyContent={"center"} m="0" p={"48px"} alignItems="center" >
      <Box d="flex" flexDirection={{ sm: "column", md: "column", lg: "column" }} borderRadius="8px">
        ...
        <Box h={{ sm: "250px", md: "380px" }} w="300px  ">
